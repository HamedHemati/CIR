# Code adapted from https://github.com/ContinualAI/avalanche/blob/master/avalanche/training/supervised/er_ace.py
...
class ER_ACE_Adaptive(SupervisedTemplate):
    """
    ...
    def __init__(
        ...
        self.storage_policy = AdaptiveBuffer(
            max_size=self.mem_size, total_num_classes=n_classes
        )
