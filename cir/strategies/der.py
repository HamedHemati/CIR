...
import copy
from typing import Callable, List, Optional, Dict, Optional, List
...
class ClassBalancedWithLogitsBuffer:
    ...
    def update_from_dataset(self, new_data: AvalancheDataset):
        ...
        self.buffer = merged_data.subset(subset_indices.tolist())
...
class DER(SupervisedTemplate):
    ...
    def __init__(
        ...
        self.storage_policy = ClassBalancedWithLogitsBuffer(
            self.mem_size
        )
